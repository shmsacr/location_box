...
abstract class $AppStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({@HiveField(1) bool themeMode, @HiveField(2) String? languageCode});
}
...
class _$AppStateImpl implements _AppState {
  const _$AppStateImpl(
      {@HiveField(1) this.themeMode = false, @HiveField(2) this.languageCode});
...
abstract class _AppState implements AppState {
  const factory _AppState(
      {@HiveField(1) final bool themeMode,
      @HiveField(2) final String? languageCode}) = _$AppStateImpl;
