...
class $AssetsLottieGen {
  ...
  String get locationGif => 'assets/lottie/location-gif.json';

  /// File path: assets/lottie/location-lottie.json
  String get locationLottie => 'assets/lottie/location-lottie.json';

  /// List of all assets
  List<String> get values => [locationGif, locationLottie];
}
